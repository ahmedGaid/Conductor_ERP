              ...
              {aiStatus?.enabled && (
                <li>
                  {withTip(
                    ...
                    >
                      <span className="sidebar__icon"><NavIcon name="knowledge" /></span>
                      <span>{t("nav.knowledgeAdmin")}</span>
                    </NavLink>,
                  )}
                </li>
              )}
              {aiStatus?.enabled && (
                <li>
                  {withTip(
                    ...
                    >
                      <span className="sidebar__icon"><NavIcon name="reports" /></span>
                      <span>{t("nav.opsAdmin")}</span>
                    </NavLink>,
                  )}
                </li>
              )}
