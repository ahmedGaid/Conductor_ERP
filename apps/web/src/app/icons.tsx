...
const PATHS: Record<string, ReactNode> = {
  ...
  // Import — upload (arrow out of tray, download's mirror). Smart Import wizard.
  import: (
    <>
      <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
      <path d="M7 8l5-5 5 5" />
  ...
  // Chevron down — combobox/select disclosure. Direction-agnostic (points block-end, not inline).
  chevronDown: <path d="M5 8.5 12 15.5 19 8.5" />,
  // Chevron start/end — month step in the date picker. The datepicker nav mirrors these in RTL
  // (CSS) so "previous" always points the natural inline-start way in both directions.
  chevronLeft: <path d="M15 5l-7 7 7 7" />,
  chevronRight: <path d="M9 5l7 7-7 7" />,
  // Calendar — date field trigger. Single-stroke, same hand as the set.
  calendar: (
    <>
