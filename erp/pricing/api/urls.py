...
urlpatterns = [
    ...
    path("price-lists/<uuid:list_id>/lines/import", views.PriceListLineImportView.as_view(), name="line-import"),
    path("price-lists/<uuid:list_id>/lines/import/template", views.PriceListLineImportTemplateView.as_view(), name="line-import-template"),
