...
urlpatterns = [
    ...
    path("report-definitions", views.ReportDefinitionListCreateView.as_view(), name="report-definition-list"),
    path("report-definitions/<uuid:definition_id>", views.ReportDefinitionDetailView.as_view(), name="report-definition-detail"),
    path("report-definitions/<uuid:definition_id>/run", views.ReportDefinitionRunView.as_view(), name="report-definition-run"),
    ...
    path("budgets/<uuid:budget_id>/lines", views.BudgetLineSetView.as_view(), name="budget-line-set"),
    path("budgets/<uuid:budget_id>/variance", views.BudgetVsActualView.as_view(), name="budget-variance"),
