...
| **7** | `Docs/plan/os-foundations-plan/` | FILE_01 → FILE_05 | **Phase W+ remainder** (plan created 2026-07-12) — Action Graph v2 (L0), verifier packs + wiring (L1), simulation engine + diff card (L2). Dedupe applied: eval harness → pos 6 FILE_01; answer self-verification → ai-reliability FILE_05 T5.8; L3 planner → later phase |
