...
page) shipped — see A9 row above. FILE_14 fully `_done`. A's next unstarted file per the
ownership map: TH FILE_19 admin panel UI, FILE_20 AI usage UI, SI FILE_12-15 wizard/preview/
adapter-review screens, or B16/B17 draftable-payments + inventory-opening review screens.
