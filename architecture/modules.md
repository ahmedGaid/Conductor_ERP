...
| web (apps/web) | "Conductor" React+TS+Vite frontend: Arabic/RTL-first i18n, design tokens, logical CSS, modern app shell (icon sidebar + command bar), dashboard (KPI cards + panels), workflow screens (React Flow canvas, execution viewer), accounting screens (COA, journal entry, list/detail, trial balance, general ledger, income statement, balance sheet, cash flow) | 3, 4, 5 | done (gate03, gate04, gate05) |
